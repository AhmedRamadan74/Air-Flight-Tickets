...
if pages == "Predict price your ticket":
    st.subheader(
        "If you will be book flight ticket from city to city in india , and want to predict your ticket price"
    )
    st.subheader("[Click here](https://air-flight-tickets-predict.streamlit.app/)")
